...
Explanation
    ...
    Sample Case #05: We will buy black gifts at their original price, 1. For white gifts, we will first black gifts worth 11 unit and color them to white with another 2 units, so cost for white gifts is reduced to 3 units. So cost of buying all gifts will be: 3∗1+3∗3=3+9=12.
...
int main(){
    ...
    for(int a0 = 0; a0 < t; a0++){
        ...
        long long int sub_b = b * x;
        long long int sub_w = w * y;
        long long int bw = x + z;
        long long int wb = y + z;
        long long int sub_bw = w * bw;
        long long int sub_wb = b * wb;
        long long int tot = sub_b + sub_w;
        long long int tot_bw = sub_b + sub_bw;
        long long int tot_wb = sub_w + sub_wb;
